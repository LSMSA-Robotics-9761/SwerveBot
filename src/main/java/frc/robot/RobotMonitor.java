 ...
 *
 */
public class RobotMonitor extends TimedRobot {
  AHRS ahrs;
  Joystick stick;
  ...
  public void teleopPeriodic() {
    ...
    // SmartDashboard.putBoolean("zeroing yaw", false);
    // if (zero_yaw_pressed) {
    //   ahrs.zeroYaw();
    //   SmartDashboard.putBoolean("zeroing yaw", true);
    // }
